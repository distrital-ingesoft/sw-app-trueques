...
curl  \
    --header "Content-Type: application/json" \
    --request POST \
    --data '{     "nombre":"Zapatos", "descripcion": "Zapatos negro", "enlaceImagen":"https://bosico.vteximg.com.br/arquivos/zapatos-para-hombre-en-diferentes-colores-y-estilos-bosi.jpg?v=638019808898300000", "precio": 2500, "estadoElemento":"usado" ,"usuario":{ "id":1 }, "categoria":{ "id":2 }, "elementosDeseados":[ { "nombre":"Casa" }, { "nombre":"Tenis" }, { "nombre":"Balon" } ]}' \
    http://127.0.0.1:8080/nuevoElementoTrueque/

curl  \
    --header "Content-Type: application/json" \
    --request POST \
    --data '{     "nombre":"Celular", "descripcion": "Iphone", "enlaceImagen":"https://tienda.claro.com.co/wcsstore/Claro/images/catalog/equipos/646x1000/70037180.jpg", "precio": 15900, "estadoElemento":"Nuevo" , "usuario":{ "id":2 }, "categoria":{ "id":3 }, "elementosDeseados":[ { "nombre":"Portatil" }, { "nombre":"Reloj" }, { "nombre":"Televisor" } ]}' \
    http://127.0.0.1:8080/nuevoElementoTrueque/
